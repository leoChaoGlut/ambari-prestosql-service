...
By default, the integration code installs Presto version ``330``. Change the
...
example, to display Presto version ``300``, run ``make dist VERSION=300``.
To download a different RPM and CLI to match version ``300``, edit the
