...
3. Oracle's JDK 1.8u151+ for Presto version 330 and over, and
   1.8u151+ for Presto versions before 330. We recommend you read the section on
...
Ambari. By default, this integration code installs Presto version ``330``,
...
* Place the integration files within the newly created PRESTO directory.
  ...
  that installs ``330`` from the `releases section of this project <https://github.com/prestosql/ambari-presto-service/releases>`_. Upload the integration archive to your cluster and extract it like so:
